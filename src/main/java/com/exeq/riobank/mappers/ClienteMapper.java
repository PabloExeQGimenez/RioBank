...
@Mapper(componentModel = MappingConstants.ComponentModel.SPRING, uses = {CardMapper.class ,CuentaMapper.class,TransactionMapper.class, ClientLoanMapper.class}) //si usa otro mapper por relaciones
